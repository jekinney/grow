            ...
            <div class="col-md-10 mt-4">
                ...
                <section class="card">
                    ...
                    <header class="card-header">
                        <h1 class="card-title">Edit a subcourse</h1>
                    </header>

                    <form action="{{ route( 'dash.subcourse.update', $course) }}" method="post" enctype="multipart/form-data" class="card-body">
                        @method('patch')
                        @csrf
                           ...
                           <div class="col">
                                ...
                                >
                                    ...
                                    @foreach( $courses as $course )
                                        <option value="{{ $course->id }}" selected="{{ $course->course_id == $course->id }}">{{ $course->name }}</option>
                                    @endforeach
                                </select>
